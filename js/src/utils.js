  ...
  embeddedVideoTransformer: function () {
    ...
    $iframes.each(function () {
      ...
      if (this.src.search(pattern) > 0) {
        ...
        // Additional adjustments for 163 Music, but there is some error with the width, so I remove the support for it in utlis.js, notice line 68 is together with the following code.
